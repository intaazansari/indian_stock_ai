...
export function MobileNav() {
  ...
  return (
    <nav className="lg:hidden fixed bottom-0 left-0 right-0 z-50 bg-white dark:bg-gray-950 border-t border-gray-100 dark:border-gray-900 flex safe-area-inset-bottom">
      {NAV_ITEMS.map((item) => {
